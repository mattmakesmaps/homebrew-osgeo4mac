...
class UnlinkedQGISQt5 < UnlinkedQGIS
  fatal true
...
class QgisQt5 < Formula
  ...
  depends_on "qscintilla2-qt5" # will probably be a C++ lib deps in near future
  depends_on "qwt-qt5"
  depends_on "gsl"
  ...
  def install
    ...
    ENV.append "CXXFLAGS", "-F#{Formula["qt5"].opt_lib}"
